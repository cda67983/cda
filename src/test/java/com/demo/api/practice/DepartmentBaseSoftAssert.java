...
public class DepartmentBaseSoftAssert {
...
//        assertEquals(departmentId,queryResponse.path("department.id[0]").toString());
        ...
        assertAll("查询返回值校验!",
                ()->assertEquals("1",queryResponse.path("errcode").toString()),
                ()->assertEquals(departmentId+"X",queryResponse.path("department.id[0]").toString()),
                ()->assertEquals(name+"X",queryResponse.path("department.name[0]").toString()),
                ()->assertEquals(eName+"X",queryResponse.path("department.name_en[0]").toString()));
    }
